...
<head>
    ...
    <!-- Bootstrap core CSS -->
    <link href="assefy/css/bootstrap.min.css" rel="stylesheet">
 
    <!-- Custom Google Web Font -->
    <link href="assefy/font-awesome/css/font-awesome.min.css" rel="stylesheet">
    <link href='http://fonts.googleapis.com/css?family=Lato:100,300,400,700,900,100italic,300italic,400italic,700italic,900italic' rel='stylesheet' type='text/css'>
	<link href='http://fonts.googleapis.com/css?family=Arvo:400,700' rel='stylesheet' type='text/css'>
	
    <!-- Custom CSS-->
    <link href="assefy/css/general.css" rel="stylesheet">
	
	 <!-- Owl-Carousel -->
    <link href="assefy/css/custom.css" rel="stylesheet">
	<link href="assefy/css/owl.carousel.css" rel="stylesheet">
    <link href="assefy/css/owl.theme.css" rel="stylesheet">
	<link href="assefy/css/style.css" rel="stylesheet">
	<link href="assefy/css/animate.css" rel="stylesheet">
	
	<!-- Magnific Popup core CSS file -->
	<link rel="stylesheet" href="assefy/css/magnific-popup.css"> 
	
	<script src="assefy/js/modernizr-2.8.3.min.js"></script>  <!-- Modernizr /-->
	<!--[if IE 9]>
		<script src="assefy/js/PIE_IE9.js"></script>
	<![endif]-->
	<!--[if lt IE 9]>
		<script src="assefy/js/PIE_IE678.js"></script>
	<![endif]-->

	<!--[if lt IE 9]>
		<script src="assefy/js/html5shiv.js"></script>
	<![endif]-->
...
<body id="home">
    ...
    <div class="intro-header">
		...
		<div class="col-xs-12 text-center abcen wow fadeIn">
			<div class="button_down "> 
				<a class="imgcircle wow bounceInUp" data-wow-duration="1.5s"  href="#whatis"> <img class="img_scroll" src="assefy/img/icon/circle.png" alt=""> </a>
			</div>
		</div>
    </div>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-sm-4 wow fadeInDown text-center">
				  <img class="rotate" src="assefy/img/icon/tweet.svg" alt="Generic placeholder image">
				  <h3>Follow Me</h3>
				...
				<div class="col-sm-4 wow fadeInDown text-center">
				  <img  class="rotate" src="assefy/img/icon/picture.svg" alt="Generic placeholder image">
				   <h3>Gallery</h3>
				   <p class="lead">Epsum factorial non deposit quid pro quo hic escorol. Olypian quarrels et gorilla congolium sic ad nauseum. </p>
				   <!-- <p><a class="btn btn-embossed btn-primary view" role="button">View Details</a></p> -->
				</div><!-- /.col-lg-4 -->
				...
				<div class="col-sm-4 wow fadeInDown text-center">
				  <img  class="rotate" src="assefy/img/icon/retina.svg" alt="Generic placeholder image">
				   <h3>Retina</h3>
					<p class="lead">Epsum factorial non deposit quid pro quo hic escorol. Olypian quarrels et gorilla congolium sic ad nauseum. </p>
				  <!-- <p><a class="btn btn-embossed btn-primary view" role="button">View Details</a></p> -->
				</div><!-- /.col-lg-4 -->
			...
			<div class="row tworow">
				...
				<div class="col-sm-4  wow fadeInDown text-center">
				  <img class="rotate" src="assefy/img/icon/laptop.svg" alt="Generic placeholder image">
				  <h3>Responsive</h3>
				  <p class="lead">Epsum factorial non deposit quid pro quo hic escorol. Olypian quarrels et gorilla congolium sic ad nauseum. </p>
				 <!-- <p><a class="btn btn-embossed btn-primary view" role="button">View Details</a></p> -->
				</div><!-- /.col-lg-4 -->
				...
				<div class="col-sm-4 wow fadeInDown text-center">
				  <img  class="rotate" src="assefy/img/icon/map.svg" alt="Generic placeholder image">
				   <h3>Google</h3>
				   <p class="lead">Epsum factorial non deposit quid pro quo hic escorol. Olypian quarrels et gorilla congolium sic ad nauseum. </p>
				   <!-- <p><a class="btn btn-embossed btn-primary view" role="button">View Details</a></p> -->
				</div><!-- /.col-lg-4 -->
				...
				<div class="col-sm-4 wow fadeInDown text-center">
				  <img  class="rotate" src="assefy/img/icon/browser.svg" alt="Generic placeholder image">
				   <h3>Bootstrap</h3>
				 <p class="lead">Epsum factorial non deposit quid pro quo hic escorol. Olypian quarrels et gorilla congolium sic ad nauseum. </p>
				  <!-- <p><a class="btn btn-embossed btn-primary view" role="button">View Details</a></p> -->
				</div><!-- /.col-lg-4 -->
        ...
        <div class="container">
            ...
            <div class="row">
				...
				<div class="col-sm-6 pull-right wow fadeInRightBig">
                    <img class="img-responsive " src="assefy/img/ipad.png" alt="">
                </div>
            ...
            <div class="row">
                <div class="col-sm-6 wow fadeInLeftBig">
                     <div id="owl-demo-1" class="owl-carousel">
						<a href="assefy/img/iphone.png" class="image-link">
							<div class="item">
								<img  class="img-responsive img-rounded" src="assefy/img/iphone.png" alt="">
							</div>
						</a>
						<a href="assefy/img/iphone.png" class="image-link">
							<div class="item">
    ...
    <div class="content-section-a">
        ...
        <div class="container">
             ...
             <div class="row">
				...
				<div class="col-sm-6 pull-right wow fadeInRightBig">
                    <img class="img-responsive " src="assefy/img/doge.png" alt="">
                </div>
          ...
          <div class="row" >
		    ...
		    <div class="row wow bounceInUp" >
              <div id="owl-demo" class="owl-carousel">
				...
				<a href="assefy/img/slide/1.png" class="image-link">
					<div class="item">
						<img  class="img-responsive img-rounded" src="assefy/img/slide/1.png" alt="Owl Image">
					</div>
				</a>
				
               <a href="assefy/img/slide/2.png" class="image-link">
					<div class="item">
						<img  class="img-responsive img-rounded" src="assefy/img/slide/2.png" alt="Owl Image">
					</div>
				</a>
				
				<a href="assefy/img/slide/3.png" class="image-link">
					<div class="item">
						<img  class="img-responsive img-rounded" src="assefy/img/slide/3.png" alt="Owl Image">
					</div>
				</a>
    ...
    <!-- JavaScript -->
    <script src="assefy/js/jquery-1.10.2.js"></script>
    <script src="assefy/js/bootstrap.js"></script>
	<script src="assefy/js/owl.carousel.js"></script>
	<script src="assefy/js/script.js"></script>
	<!-- StikyMenu -->
	<script src="assefy/js/stickUp.min.js"></script>
	...
	<!-- Smoothscroll -->
	<script type="text/javascript" src="assefy/js/jquery.corner.js"></script> 
	<script src="assefy/js/wow.min.js"></script>
	<script>
	 new WOW().init();
	</script>
	<script src="assefy/js/classie.js"></script>
	<script src="assefy/js/uiMorphingButton_inflow.js"></script>
	<!-- Magnific Popup core JS file -->
	<script src="assefy/js/jquery.magnific-popup.js"></script> 
</body>
